...
class InputBoxA extends Component {
        ...
        return(
            <div>
                ...
                <div class="card-body">
                    ...
                    <Slider name="anodeThickness" min="0" max="100"/>
                    <p>{this.context[0]["components"]["anode"]["thickness"]}</p>
                    ...
                    <Slider name="anodePorosity" min="0" max="100"/>
                    <p>{this.context[0]["components"]["anode"]["porosity"]}</p>
                    ...
                    <Dropdown name="anodeMaterial" itemlist={["Graphite"]} active={this.context[0]["components"]["anode"]["material"]}/>
                    </div>
                </div>
            </div>
        )
